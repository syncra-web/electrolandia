// Sprite de iconos del design system ELECTROLANDIA.
// Line icons · viewBox 24x24 · trazo 1.75 · heredan currentColor.
// Se renderiza UNA vez en el <body> (layout). Uso: <Icon name="bolt" />
// Fuente: Desing_system_By_syncraev/assets/icons.js (verbatim).

export const ICON_PATHS: Record<string, string> = {
  // --- Energy / EV ---
  bolt: '<path d="M13 2 4.5 13.5H11l-1 8.5 8.5-11.5H12l1-8.5Z"/>',
  battery:
    '<rect x="2" y="7" width="16" height="10" rx="2.5"/><path d="M21 10v4"/><path d="M6 10v4M9.5 10v4M13 10v4"/>',
  "battery-charging":
    '<path d="M11 7H4.5A2.5 2.5 0 0 0 2 9.5v5A2.5 2.5 0 0 0 4.5 17H8"/><path d="M14 7h1.5A2.5 2.5 0 0 1 18 9.5v5a2.5 2.5 0 0 1-2.5 2.5H14"/><path d="M21 10v4"/><path d="M11.5 6 8.5 12H12l-3 6"/>',
  plug: '<path d="M9 2v5M15 2v5"/><path d="M6 7h12v3a6 6 0 0 1-6 6 6 6 0 0 1-6-6V7Z"/><path d="M12 16v6"/>',
  "ev-connector":
    '<rect x="5" y="3" width="14" height="13" rx="6.5"/><circle cx="9.5" cy="8" r="1.4"/><circle cx="14.5" cy="8" r="1.4"/><circle cx="12" cy="12" r="1.4"/><path d="M9 19h6M12 16v6"/>',
  station:
    '<path d="M5 21V6a3 3 0 0 1 3-3h4a3 3 0 0 1 3 3v15"/><path d="M3 21h14"/><path d="M9 9h4"/><path d="M15 11h2.5a2 2 0 0 1 2 2v3.5a1.8 1.8 0 0 0 3.5 0V9l-2.5-2.5"/>',
  gauge:
    '<path d="M12 14 16 9"/><circle cx="12" cy="13" r="0.8" fill="currentColor"/><path d="M4 18a8 8 0 1 1 16 0"/><path d="M4 18h16"/>',
  leaf: '<path d="M11 20A7 7 0 0 1 4 13c0-5 4-9 16-9 0 9-4 16-9 16Z"/><path d="M11 20c0-5 2-8 7-11"/>',
  route:
    '<circle cx="6" cy="19" r="2.5"/><circle cx="18" cy="6" r="2.5"/><path d="M8.5 19H14a3.5 3.5 0 0 0 0-7H10a3.5 3.5 0 0 1 0-7h5.5"/>',
  sparkle:
    '<path d="M12 3v4M12 17v4M3 12h4M17 12h4"/><path d="m6.5 6.5 2 2M15.5 15.5l2 2M17.5 6.5l-2 2M8.5 15.5l-2 2"/>',
  ...
  "calendar-check":
    '<rect x="3.5" y="5" width="17" height="16" rx="2.5"/><path d="M3.5 9.5h17M8 3v4M16 3v4"/><path d="m9 15 2 2 4-4"/>',
  ...
  // --- Nav / UI ---
  home:
    '<path d="M4 11.5 12 4l8 7.5"/><path d="M6 10v9.5a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V10"/><path d="M10 20.5V14h4v6.5"/>',
  ...
  phone:
    '<path d="M6 3h3l1.5 5-2 1.5a12 12 0 0 0 5 5l1.5-2 5 1.5v3a2 2 0 0 1-2 2A16 16 0 0 1 4 5a2 2 0 0 1 2-2Z"/>',
  whatsapp:
    '<path d="M3.5 20.5 5 16.5a8 8 0 1 1 3 3l-4.5 1Z"/><path d="M9 9.5c0 3 2.5 5.5 5.5 5.5.7 0 1.2-.7 1-1.3l-.4-1a.8.8 0 0 0-1-.4l-.8.3a4 4 0 0 1-2-2l.3-.8a.8.8 0 0 0-.4-1l-1-.4c-.6-.2-1.3.3-1.3 1Z"/>',
...
/** Sprite oculto. Renderizar una sola vez, al inicio del <body>. */
export function IconSprite() {
  return (
    ...
    >
      {Object.entries(ICON_PATHS).map(([name, inner]) => (
        <symbol
          key={name}
          id={`i-${name}`}
          viewBox="0 0 24 24"
