...
- **Tailwind CSS** (tokens en `src/app/globals.css`; fuentes Sora + Manrope vía `next/font`)
...
3. **Pulir la UI** (mobile-first) siguiendo los tokens de `globals.css`. Revisar estados de carga, vacíos y errores.
